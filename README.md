...
### 📊 데이터 엔지니어 인턴 — 프롭메이트 서비스  
**기간:** 2025년 6월 ~ 2025년 8월 | **지역:** 대한민국 서울  

#### 주요 업무
- 공공데이터 API 기반 부동산 빅데이터 수집·전처리
- LightGBM 기반 부동산 가격 5년 예측 모델 개발
- 토지 투자 가치 평가 및 건축 가능성 분석 AI 시스템 구축

#### 보유 기술
`Python` `Pandas` `Selenium` `LightGBM` `데이터 전처리` `데이터 시각화` `머신러닝` `API 데이터 수집`

---

### 📈 데이터 엔지니어 인턴 — 코드그림 서비스  
**기간:** 2025년 6월 ~ 2025년 8월 | **지역:** 대한민국 서울  

#### 주요 업무
- Prophet 기반 16개 산업 분야 글로벌 마케팅 트렌드 예측 (2025~2030)
- Google Trends 데이터 기반 다국가 키워드 검색량 분석
- CRM 데이터 분석을 통한 개인화 추천 시스템 구축

#### 보유 기술
`Python` `Pandas` `Prophet` `데이터 전처리` `데이터 시각화` `머신러닝` `Google Trends API`

---

### 📑 데이터 엔지니어 인턴  
**기간:** 2024년 7월 ~ 2024년 10월 | **지역:** 대한민국 서울  

#### 주요 업무
- 데이터 수집·가공 및 분석
- Python 기반 데이터 전처리 및 자동화
- 데이터 시각화 및 리포트 생성
...
### 🛠 데이터 엔지니어 인턴  
**기간:** 2021년 9월 ~ 2021년 12월 | **지역:** 대한민국 인천  

#### 주요 업무
- 공공데이터 포털 API 점검
- 데이터 정제 및 품질 검수
- Excel·Python 기반 데이터 클렌징
